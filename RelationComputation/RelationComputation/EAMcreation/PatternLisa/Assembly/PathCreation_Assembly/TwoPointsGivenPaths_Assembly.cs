...
namespace AssemblyRetrieval.PatternLisa.Assembly.PathCreation_Assembly
{
    public partial class Functions
    {
        ...
        public static void TwoPointsGivenPaths_Assembly(MyMatrAdj matrAdjToSee, int n, int startPointInd,
            int secondPointInd, List<MyRepeatedComponent> listOfComponents, List<MyVertex> listOfOrigins,
            ...
            //the path equation yet. So I guide the 3rd point search.
            {
                ...
                foreach (var branch2 in branchesSecond)
                {
                        ...
                        pathObject.path.Contains(startPointInd) && pathObject.path.Contains(branch2))) == -1)
                    {
                        ...
                        if (listOfOrigins[branch2].Lieonline(FunctionsLC.LinePassingThrough(listOfOrigins[startPointInd], listOfOrigins[secondPointInd])))
                        {
                            currentPath = Part.PathCreation_Part.Functions.ThreePointsGivenPathsLine(matrAdjToSee, listOfOrigins,
        ...
        public static void KLTwoPointsGivenPaths_Assembly(MyMatrAdj matrAdjToSee, int n, int startPointInd,
    int secondPointInd, List<MyRepeatedComponent> listOfComponents, List<MyVertex> listOfOrigins,
    List<int> listOfExtremePoints, ref List<int> listOfSimplePoints_Copy, List<int> listOfMBPoints,
    ref bool longestPattern, ref List<MyPathOfPoints> listOfPaths, ref List<int> listOfPenultimate,
    ref List<int> listOfLast, ref StringBuilder fileOutput, ref bool toleranceOk,
